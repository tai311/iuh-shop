...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const documents =
        document.querySelectorAll(".policy-document");
    ...
    documents.forEach(function (card) {

        card.addEventListener("mousemove", function (event) {

            if (
                card.classList.contains(
                    "policy-document-coming"
                )
            ) {
                return;
            }
    ...
    const comingDocuments =
        document.querySelectorAll(
            ".policy-document-coming"
        );


    comingDocuments.forEach(function (card) {
